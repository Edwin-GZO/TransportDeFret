...
<div className="split leftMots">
    ...
    <p className="pMots">Transports TDR est une entreprise française fondée en 1980, spécialisée dans le groupage et la distribution de fret à haute valeur ajoutée. Nos entrepôts sécurisés sont idéalement situés aux croisements des axes autoroutiers et nous permettent de proposer tout une gamme de prestations logistiques.</p>
    </div>
